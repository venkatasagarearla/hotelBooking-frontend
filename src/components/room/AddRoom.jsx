...
import RoomTypeSelector from "../common/RoomType"
...
const AddRoom=()=>{
    ...
    const handleSubmit= async(e)=>{
        ...
        try{
           ...
           if(sucess !==undefined){
            setSucessMessage("A new room was added to the database")
   ...
   <section className="container,mt-5 mb-5">
    <div className="row justify-content-center">
       ...
       <h2 className="mt-5 mb-2">
        ...
        {sucessMessage && (
							<div className="alert alert-success fade show"> {sucessMessage}</div>
						)}
           ...
           <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
                <label htmlFor="photo" className="form-label">Room Photo</label>
                  <input required
                  id="photo" name="photo" type="file" className="form-control" onChange={handleImageChange}/>
                  {imagePreview &&(
